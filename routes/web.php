...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/rekam/download/{id}', [RekamController::class, 'download'])->name('rekam.download');
    ...
    Route::get('/rekam/download/{id}', [App\Http\Controllers\RekamController::class, 'download'])->name('rekam.download');
