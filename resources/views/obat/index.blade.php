                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="stock" required class="form-control" value="{{old('stock')}}">
                            @error('stock')
                            <div class="invalid-feedback animated fadeInUp"
                            style="display: block;">{{$message}}</div>
                            @enderror
                                                            ...
                                                            <form action="{{Route('obat.update',$row->id)}}" method="POST">
                                                               ...
                                                               <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="text-black font-w500">Stok*</label>
                                                                        <input type="number" name="stock" required class="form-control" value="{{old('stock') ? old('stock') : $row->stock}}">
                                                                        @error('stock')
                                                                        <div class="invalid-feedback animated fadeInUp"
                                                                        style="display: block;">{{$message}}</div>
                                                                        @enderror
